...
edges.to_csv('outputs/Bushra-Hoorani-edges.csv', encoding='utf-8-sig', index=False)
nodes.to_csv('outputs/Bushra-Hoorani-nodes.csv', encoding='utf-8-sig', index=False) 
