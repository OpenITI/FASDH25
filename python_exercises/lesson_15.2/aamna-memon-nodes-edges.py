...
edges.to_csv ('outputs/aamna-memon-edges.csv', encoding= 'utf-8-sig',index=False)
nodes.to_csv ('outputs/aamna-memon-nodes.csv', encoding='utf-8-sig', index= False)
