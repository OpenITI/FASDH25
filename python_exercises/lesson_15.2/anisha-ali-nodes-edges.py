...
# 3. Save to CSV
edges.to_csv(f'outputs/anisha-ali-edges.csv', encoding='utf-8-sig', index=False)
nodes.to_csv(f'outputs/anisha-ali-nodes.csv', encoding='utf-8-sig',index=False)
