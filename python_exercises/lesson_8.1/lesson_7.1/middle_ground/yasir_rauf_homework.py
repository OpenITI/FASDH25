#1. Write the lines of code that open your mARkdown file and load the text as a list of lines (the list of lines needs to be assigned to a variable). Print the first 10 lines.
...
for heading in first_level_headings:
    print(heading, end ="")# used end= "" so the lines are printed as they are keeping spaces and newlines.
