...
patterns = [r"Israilr?", r"Palestine|Palestinian", r"Gazan?"]
for pattern in patterns:
    matches =re.fidall(pattern, body)
    n_matches = len(matches)
    print(f"{filenames} contains {n_matches} {patterns} times in the body of the article")
