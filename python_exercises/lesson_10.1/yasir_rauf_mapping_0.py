...
coordinates_df = pd.read_csv(gazetteer_path, sep="\t") #keyword arguments 
...
fig = px.scatter_map(coordinates_df, lat="latitude", lon="longitude",
                     hover_name="asciiname")#fig is customary

fig.update_layout(map_style='carto_positron-nolabels')
