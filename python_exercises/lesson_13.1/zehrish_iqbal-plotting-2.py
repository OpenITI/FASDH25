...
#save to html
fig1.write_html("outputs/Zehrish-Iqbal-short-articles.html")
...
#save as html
fig2.write_html("outputs/Zehrish-Iqbal-2023-2024.html")
...
#save as htlm
fig3.write_html("outputs/Zehrish-Iqbal-Q4-2023.html")
