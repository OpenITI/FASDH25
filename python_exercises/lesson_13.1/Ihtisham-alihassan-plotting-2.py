...
# Save plot as HTML
fig1.write_html('outputs/Ihtisham-alihassan-length-under-300.html')
...
# Save as HTML
fig2.write_html('outputs/Ihtisham-alihassan-2023-2024.html')
...
# Save as HTML
fig3.write_html('outputs/Ihtisham-alihassan-oct-dec-2023.html')
