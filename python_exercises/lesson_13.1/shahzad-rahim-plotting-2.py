...
# Save plot as HTML
fig1.write_html('outputs/shahzad-rahim-length-under-300.html')
...
fig2.add_annotation(x=500, y=150, text="high article count in 2024", showarrow=True, arrowhead=1)

# Save as HTML
fig2.write_html('outputs/shahzad-rahim-2023-2024.html')
...
fig3.add_annotation(x=500, y=70, text="high article count in december", showarrow=True, arrowhead=2)

# Save as HTML
fig3.write_html('outputs/shahzad-rahim-oct-dec-2023.html')
