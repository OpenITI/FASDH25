...
#save to html
fig1.write_html("outputs/Dilawaiz-DeeyaDidar-short-articles.html")
...
#save as html
fig2.write_html("outputs/Dilawaiz-DeeyaDidar-2023-2024.html")
...
#save as htlm
fig3.write_html("outputs/Dilawaiz-DeeyaDidar-Q4-2023.html")
