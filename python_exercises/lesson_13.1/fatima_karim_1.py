...
top_20.to_csv('outputs/fatima-karim-top20.csv', index=False)
...
first_half_2023.to_csv('outputs/fatima-karim-6m2023.csv', index=False)

# Confirm export of first-half 2023 articles
print("Exported articles from Jan–June 2023 to 'fatima-karim-6m2023.csv'.")
