...
# Save to HTML file
fig1.write_html("outputs/shabir-karim-short-articles.html")
...
# Save to HTML file
fig2.write_html("outputs/shabir-karim-2023-2024-article-length.html")
...
# Save to HTML file
fig3.write_html("outputs/shabir-karim-oct-nov-dec-2023.html")
