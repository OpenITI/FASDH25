# import pandas
import pandas as pd
#bringing the title columns
df=pd.read_csv('data/title.csv')
print(list(df.columns))

#print longest article, helped by ChatGPT
...
#export 20 articles to csv, got helip from ChateGPT
top20_df = df.sort_values(by="length", ascending=False).head(20)
top20_df.to_csv("outputs/aqsa-anwerali-top20.csv", index=False)

#combined year month and date
...
df_2023_6m.to_csv("outputs/aqsa-anwerali-6m2023.csv", index=False)
