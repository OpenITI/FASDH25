...
#read the path 
path_csv = "C:/Users/LENOVO/Downloads/FASDH25/python_exercises/lesson_13.1/data/title.csv"
...
filtered_articles.to_csv('outputs/sarir-ahmad-6m2023.csv', index=False)
