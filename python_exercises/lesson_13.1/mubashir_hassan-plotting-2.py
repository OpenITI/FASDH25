...
fig1.write_html("outputs/mubashir-hassan-short-articles.html")
...
fig2.write_html("outputs/mubashir-hassan-2023-2024.html")
...
fig3.write_html("outputs/mubashir-hassan-q4-2023.html")
print("successfully saved")
