...
fig1.write_html("outputs/Sehrish-Hakim-short-articles.html")
...
# Save as HTML file
fig2.write_html("outputs/Sehrish-Hakim-articles-2023-2024.html")
...
# Save the plot
fig3.write_html("outputs/Sehrish-Hakim-OCT-NOV-DEC-2023.html")
