...
import pandas as pd
# Path to read
path_csv = "C:/users/LAPTOPWALE/Downloads/FASDH25/python_exercises/lesson_13.1/data/title.csv"
# read 
...
top_20_articles.to_csv("outputs/karim-ullah-top20.csv", index=False)
...
df_6m2023.to_csv("outputs/karim-ullah-6m2023.csv", index=False)
