...
fig1.write_html("outputs/karim-ullah-short-articles.html")
...
# Export the plot to an HTML file
fig2.write_html("outputs/karim-ullah-2023-2024-articles.html")
...
# Export the plot to an HTML file
fig3.write_html("outputs/karim-ullah-q4-2023-articles.html")
