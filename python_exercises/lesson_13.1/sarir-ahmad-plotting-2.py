...
print(df.columns) #to see the column
#to plot a histogram
...
fig1.write_html("outputs/ayesha-munshi-short-under300.html")
...
fig2.write_html("outputs/sarir-ahmad-2023-2024-hist.html")
...
fig3.write_html("outputs/sarir-ahmad-octdec2023.html")
