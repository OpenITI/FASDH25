...
fig1.write_html("outputs/{komal}-{ali}-short-articles.html")
...
fig2.write_html("outputs/{komal}-{ali}-articles-2023-2024.html")
...
fig3.write_html("outputs/{komal}-{ali}-final_2023_articles.html")
