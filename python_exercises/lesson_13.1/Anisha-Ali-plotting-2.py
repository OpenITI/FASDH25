...
# saving to html
fig1.write_html("outputs/Anisha-Ali-short-articles.html")
...
# saving to html
fig2.write_html("outputs/Anisha-Ali-2023&2-2024-article-length.html")
...
# saving to html
fig3.write_html("outputs/Anisha-Ali-(0ct-Dec, 2023)-articles.html")
