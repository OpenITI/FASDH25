...
fig1.write_html("outputs/{aqsa}-{anwerali}-short-articles.html")
...
fig2.write_html("outputs/{aqsa}-{anwerali}-articles-2023-2024.html")
...
fig3.write_html("outputs/{aqsa}-{anwerali}-final_2023_articles.html")
