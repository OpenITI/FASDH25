...
#finding first most repeated unigrams in the corpus
five_unigrams = df.groupby("1-gram")["count"].sum().nlargest(5).index.tolist()
print("Top 5 unigrams:", five_unigrams)

#top five unigrams
df_top5 = df[df["1-gram"].isin(five_unigrams)].copy()
print(df_top5)
...
#plotting the evolution of the 5 unigrams globally
...
fig.show()
#saving html file
fig.write_html("ali_hasnain_top_5_unigrams_evolution.html")
