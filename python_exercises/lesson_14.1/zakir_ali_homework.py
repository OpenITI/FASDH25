...
# Top 5 unigrams in the corpus
top5 = df.groupby('1-gram')['count'].sum().nlargest(5).index.tolist()

# Filter only rows with those top 5 unigrams and create a copy
...
# Group by year month and '1-gram'
...
fig.write_html("top5_unigrams_plot.html")
# show the plot
fig.show()
